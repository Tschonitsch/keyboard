    ...
    */
    [_BASE] = LAYOUT( 
        ...
        KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       KC_VOLD,        XXXXXXX,    KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
            KC_LGUI,    XXXXXXX,    KC_LALT,    XXXXXXX,    KC_SPC,                                              KC_ENT,     TG(_FUNC),    KC_RCTL,     KC_RALT,    KC_RGUI
    ),
    ...
    */
    [_FUNC] = LAYOUT(
        ...
        KC_LCTL,    KC_Z,       KC_X,       KC_C,       KC_V,       KC_B,       MS_LEFT,        MS_UP,      KC_N,       KC_M,       KC_COMM,    KC_DOT,     KC_SLSH,    KC_RSFT,
            KC_LGUI,    XXXXXXX,    KC_LALT,    XXXXXXX,    MS_BTN1,                                             MS_BTN2,     TG(_FUNC),    KC_RCTL,     KC_RALT,    KC_RGUI
    )
};
